...
Route::group(['prefix'=>'admin','middleware'=>'adminmiddleware'], function () {
    ...
    Route::get('categorie/xoa/{id}','categorie@xoa')->name('xoa');
    // quận huyện
    Route::resource('districts','districts');
    Route::get('districts/xoa/{id}','districts@xoakv')->name('xoakv');
    ...
    Route::group(['prefix'=>'motelrooms'],function(){
        ...
        // list các phòng đã có người đăng ký
        Route::get('list2','AdminController@getListMotel2')->name('list2');
    });
...
Route::group(['prefix'=>'user'], function () {
    ...
    // người đi thuê đăng ký thuê nhà
    Route::post('thuenha/{id}','UserController@thue')->name('thue')->middleware('dangtinmiddleware');
    // chủ trọ xác nhận cho thuê
    Route::get('xacnhan/{id}','UserController@xacnhan')->name('xacnhan')->middleware('dangtinmiddleware');
});
/* ----*/
