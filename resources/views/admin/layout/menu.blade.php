							...
							<div class="media">
								<div class="media-body pt-5">
									...
									<div class="text-size-mini text-muted">
										<i class="icon-pin text-size-small"></i> Thái Nguyên 
									</div>
								</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li><a href="{{route('categorie.index')}}"><i class="glyphicon glyphicon-tasks"></i> <span>Danh sách các loại phòng trọ</span></a></li>
								<li><a href="{{route('districts.index')}}"><i class="glyphicon glyphicon-stats"></i> <span>Danh sách quận huyện</span></a></li>
								<li><a href="admin/motelrooms/list"><i class="icon-home4"></i> <span>Danh sách Phòng trọ</span></a></li>
								<li><a href="admin/motelrooms/list2"><i class="glyphicon glyphicon-thumbs-up"></i> <span>Phòng trọ đã có người ở</span></a></li>
