								...
								<div class="row">
									<div class="form-group">
										...
										<div class="col-lg-10">
											<div class="input-group">
												...
												<input type="text" name="username" value="{{$user->username}}" class="form-control" placeholder="username lớn hơn 4 kí tự">
											</div>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-git-pull-request"></i></span>
												<input type="date" value="{{$user->dateofbrith}}" name="dateofbrith" class="form-control" placeholder="ngày tháng năm sinh">
											</div>
										</div>
									</div>
									<div class="form-group">
...
{{--									</div>--}}
{{--									<div class="form-group">--}}
{{--										<label class="control-label col-lg-2">Ngày tháng năm sinh:</label>--}}
{{--										<div class="col-lg-10">--}}
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select class="form-control" name="Quyen">
												...
												selected=""
												@endif
												value="2">Quản trị viên</option>
												<option
												@if($user->right == 1)
												selected=""
												@endif
												value="1">Người cho thuê</option>
												<option
												@if($user->right == 0)
												selected=""
												@endif
												value="0">Người đi thuê</option>
											</select>
										</div>
									</div>
									<div class="form-group">
