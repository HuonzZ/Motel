    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="row">
                ...
                <form action="{{route('categorie.update',$sua->id)}}" method="post">
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label >Tên thể loại:</label>
                        <input type="text" class="form-control" id="title" name="name" value="{{$sua->name}}" onkeyup="ChangeToSlug()">
                        <br>
                        <label >Slug:</label>
                        <input type="text" class="form-control" id="slug" name="slug" value="{{$sua->slug}}">
