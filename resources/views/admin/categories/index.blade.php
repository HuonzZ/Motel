...
{{--                        </div>--}}
                        ...
                        @endif
                        <a href="{{route('categorie.create')}}"><i class="glyphicon glyphicon-plus" ></i> Thêm</a>
                        <table class="table datatable-show-all">
                            <thead>
                            <tr class="bg-blue">
                                <th>ID</th>
                                <th>Loại phòng trọ</th>
                                <th>Slug</th>
...
{{--                                                    <li><a href="{{route('categorie.create')}}"><i class="glyphicon glyphicon-plus" ></i> Thêm</a></li>--}}
                                                    <li><a href="{{url('admin/categorie/'.$tl->id.'/edit')}}"><i class="glyphicon glyphicon-pencil" ></i> Sửa</a></li>
                                                    <li><a href="{{route('xoa',$tl->id)}}"><i class="glyphicon glyphicon-trash"></i> Xóa</a></li>
