		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
		            ...
		            @endif
					<form class="form-horizontal" method="POST" action="{{ route('user.register2') }}" >
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<div class="form-group">
							<label class="control-label col-sm-3" for="email">Tên tài khoản:</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="txtuser" placeholder="Tài khoản đăng nhập hệ thống">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3" for="pwd">Họ tên đầy đủ:</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="txtname" placeholder="Họ tên đầy đủ">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3" for="pwd">Số điện thoại:</label>
							<div class="col-sm-9">
								<input type="number" class="form-control" name="txtphone" placeholder="Số điện thoại của bạn">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3" for="pwd">Email:</label>
							<div class="col-sm-9">
								<input type="email" class="form-control" name="txtemail" placeholder="Email của bạn">
							</div>
						</div>
						<div class="form-group">
...
{{--						<div class="form-group">--}}
{{--							<label class="control-label col-sm-3" for="pwd">Quyền chủ phòng:</label>--}}
{{--							<div class="col-sm-9">--}}
{{--								<input type="password" class="form-control"  name="txt-repass" placeholder="Quyền chủ phòng">--}}
{{--							</div>--}}
{{--						</div>--}}
